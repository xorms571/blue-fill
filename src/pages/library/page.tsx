  ...
  return (
    <PageLayout>
      ...
      <header className="mb-16 space-y-4">
        ...
        <Button variant="solid" size="m" className="rounded-full px-10 h-11 text-base-950 font-bold mt-4" leftIcon={<PlusIcon />} onClick={() => navigate('/library/new')}>캐릭터 생성하기</Button>
      </header>
